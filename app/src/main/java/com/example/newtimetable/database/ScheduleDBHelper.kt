...
class ScheduleDBHelper(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        db?.execSQL("CREATE TABLE $TABLE_SCHEDULE($KEY_ID INTEGER PRIMARY KEY, $KEY_DAY TEXT, $KEY_CLOCK TEXT, $KEY_HOURS INTEGER, $KEY_MINUTES INTEGER, $KEY_LESSON TEXT, $KEY_TEACHER TEXT, $KEY_CLASS TEXT, $KEY_WEEK TEXT)")
    }
